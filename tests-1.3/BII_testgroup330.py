...
class Testcase_330_20_table_features_wildcards(base_tests.SimpleDataPlane):
    """
    Purpose
    Verify all reported wildcard OXMs can be matched against.

    Methodology
    Configure and connect DUT to controller.  After control channel establishment, send an ofp_multipart_request with type OFPMP_TABLE_FEATURES, and no body. Verify that all reported fields under OFPTFPT_WILDCARDS can be wildcarded.

    """
    @wireshark_capture
    def runTest(self):
        logging.info("Running testcase 330.20 table features wildcards")
...
class Testcase_390_40_packet_out_action_field(base_tests.SimpleDataPlane):
    """
    Purpose
    ...
    @wireshark_capture
    def runTest(self):
        logging.info("Running testcase 390.40 packet out action field")
        logging.info("Running in testcase 390.100")


class Testcase_390_60_packet_out_data(base_tests.SimpleDataPlane):
    """
    Purpose
    ...
    @wireshark_capture
    def runTest(self):
        logging.info("Running testcase 390.60 packet out data")
        logging.info("Running in testcase 200.110")
...
class Testcase_390_120_barrier(base_tests.SimpleDataPlane):
    """
    Purpose
    ...
    @wireshark_capture
    def runTest(self):
        logging.info("Running testcase 390.120 barrier")
        logging.info("Running in testcase 200.170")